Module mainModule
    Const FolderLocation As String = "I:\EcomNEW\DigitalCommerce\Merchandising Operations\Digital Reset Scorecard\CEP Supplier Outreach\Attachments\"

    Sub EmailLoop()
        '***********************************************************************************************************************
        'Purpose: Send emails to suppliers that need to update item information
        '***********************************************************************************************************************
        ...
        Dim strFile As String, File1 As String, File2 As String, File3 As String
        strFile = Dir(FolderLocation)
        Do While Len(strFile) > 0
            If InStr(strFile, "Image Guide") Then
                File1 = strFile
            ElseIf InStr(strFile, "CEP") Then
                File2 = strFile
            ElseIf InStr(strFile, "Training Schedule") Then
                File3 = strFile
            strFile = Dir
        Loop
        ...
        For Each vendor In VendorSheet.Range("C2:C" & lastRow(VendorSheet))
            ...
            For Each template In templates
                ...
                'Create Outlook object and send email
...
nextVendor:
    ...
    '***********************************************************************************************************************
    'Purpose: Speed up code runtime and reduce lines of code in main sub
    '***********************************************************************************************************************
    ...
    '***********************************************************************************************************************
    'Purpose: Finds the last used cell row in a worksheet
    '***********************************************************************************************************************
    ...
    '***********************************************************************************************************************
    'Purpose: Converts vendor items into the appropriate HTML code for email body
    '***********************************************************************************************************************
